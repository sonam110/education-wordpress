...
<section class="main-slider-area">
  ...
  <div class="formmm">
    <div >
      ...
      <form class="wpcf7-form"  action="" method="post" name="myform">
        <p><strong class="title">BOOK A FREE TRIAL CLASS</strong></p>
        <p>
        ...
        <p>
          ...
          <input type="submit" name="submitnow" value="REQUEST FOR CLASS" onclick="setCookie('<?php echo $_POST['emailid']; ?>');">
          <br>
