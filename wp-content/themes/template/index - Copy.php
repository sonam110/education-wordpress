...
<?php   $i=0;
	...
	$slider_image = wp_get_attachment_url( get_post_thumbnail_id($post->ID));
	 ...
	 ?>		
            <li class="slide__item item-bg-<?php echo $i; ?>">
              <div class="slide-caption">
                <h2 class="slide-caption__title"><?php echo the_title(); ?></h2>
                <p class="slide-caption__desc"><?php echo  the_content(); ?></p>
                <a href="<?php the_permalink() ?>" title="Permanent Link to <?php the_title_attribute(); ?>">Learn More</a>
              </div>
            </li>
	...
	<?php endwhile; endif; ?>		
          <!--- <li class="slide__item item-bg-2">
              <div class="slide-caption">
                ...
                <p class="slide-caption__desc">world class university</p>
...
<div class="formmm">
<div role="form" class="wpcf7" id="wpcf7-f120-p8-o1" lang="en-US" dir="ltr">
...
<p><label> <span class="wpcf7-form-control-wrap your-message"><textarea name="your-message" cols="40" rows="4" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Add your Message"></textarea></span> </label></p>

<p><input type="submit" value="REQUEST A CALLBACK" class="wpcf7-form-control wpcf7-submit"><span class="ajax-loader"></span><br>
...
<div class="wpcf7-response-output wpcf7-display-none"></div></form>
        ...
        <div class="container">
            <div class="row animatedParent animateOnce">
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="features-col animated fadeInUpShort slow">
                        <div class="features-img">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/features/1.jpg" alt="">
                            <div class="over-shadow"></div>
                        </div>
                        <h4>progressive programs</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque commodi, nostrum accusantium odit voluptatum, quos repellendus officia.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="features-col animated fadeInUpShort slow delay-250">
                        <div class="features-img">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/features/2.jpg" alt="">
                            <div class="over-shadow"></div>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="features-col animated fadeInUpShort slow delay-500">
                        <div class="features-img">
                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/features/3.jpg" alt="">
                            <div class="over-shadow"></div>
                        </div>
    ...
    <?php  
	$aboutus_image = wp_get_attachment_url( get_post_thumbnail_id($post->ID) ); 
	...
	$aboutus_image = wp_get_attachment_url( get_post_thumbnail_id($post->ID));
	 ...
	 ?>	
                    <div class="about-img animated fadeInRightShort slow">
                        <img src="<?php echo $aboutus_image; ?>" alt="">
                    </div>
					 <?php endwhile; endif; ?>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="course-col animated fadeInUpShort slow">
                        <div class="course-item">
                            ...
                            <p><?php echo  the_content(); ?></p>
                            <a class="btn btn-primary my-btn" href="<?php the_permalink(); ?>" role="button">Details</a>
                        </div>
                    </div>
                </div>
	<?php   endwhile; endif; ?>			
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="teachers-col animated fadeInUpShort slow">
                        <div class="teacher-img">
                            ...
                            <a href="<?php the_permalink(); ?>"><i class="fa fa-plus link" aria-hidden="true"></i></a>
                        </div>
                        <h4><a href="<?php the_permalink(); ?>"><?php echo the_title(); ?></a></h4>
                    </div>
                </div>
	...
	?>									
                            ...
                            <div class="col-sm-4 col-md-4 filtr-item" data-category="3, 2" data-sort="value">
                                <div class="img-hover-item clearfix">
                                    ...
                                    <a href="<?php echo $portfolio_image; ?>" data-lightbox="lightbox" data-title="My caption"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                </div>
                            </div>
<?php   endwhile; endif; ?>								
	...
	?>					
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                     <div class="blog-col animated fadeInUpShort slow">
                         <div class="blog-img">
                            <img src="<?php echo $latestnews_image; ?>" alt="">
                            <!---<div class="post-date">
