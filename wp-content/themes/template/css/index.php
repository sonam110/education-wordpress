      ...
      <form class="wpcf7-form" novalidate="novalidate" action="" method="POST">
        ...
        <p>
          <label> <span class="wpcf7-form-control-wrap your-message">
            <textarea name="message" cols="40" rows="4" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Add your Message" required></textarea>
            </span> </label>
        </p>
        <p>
...
<section class="about-section">
  <div class="container myy-1">
    <div class="row animatedParent animateOnce myy-2">
      <div class="col-lg-7">
	...
	$aboutus_image = wp_get_attachment_url( get_post_thumbnail_id($post->ID));
	 ...
	 ?>
        <div class="about-img animated fadeInRightShort slow"> <img src="<?php echo $aboutus_image; ?>" alt=""> </div>
        <?php endwhile; endif; ?>
      </div>
    </div>
  </div>
	...
	?>
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="teachers-col animated fadeInUpShort slow">
          <div class="teacher-img"> <img src="<?php echo $teacher_image; ?>" alt=""> 
