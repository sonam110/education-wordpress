...
$current_Plugin_folder_name = "index-slider";
$Page_Title = "Index Slider";
$page_url = 'index-slider';
...
global $wpdb;
$querystr = "SELECT  * from ".$wpdb->prefix."index_slider where id=".$_GET['id'];
...
<?php }
 ...
 <div class="wrap">
 <h2><?php echo $Page_Title ; ?>  List  <a class="add-new-h2" href="<?php echo $url = admin_url(); ?>admin.php?page=mt-top-level-handle-<?php echo $page_url; ?>&action=add">Add New   </a></h2>
  <div class="wpseotab general active">
  ...
  if($success_message!='') { ?>  <div class="updated below-h2" id="message"><p>  <?php echo $success_message; ?></p></div> <?php } ?> 
        ...
        <th scope="row" style="width:25%!important"><label for="yoast_wpseo_focuskw">Subject</label> </th>
            	...
            	<tr <?php if($i%2=='0') { ?>  style="background-color:white!important;"<?Php } ?>>
                    ...
                    <td width="10%">  <img src="<?php $upload_dir = wp_upload_dir(); echo $upload_dir['baseurl']; ?>/photogallery/<?php echo $post->gallery_image; ?>" height="100" width="100" /></td>
                   
                      <td><img src="<?php echo $plugins_url = plugins_url()."/".$current_Plugin_folder_name; ?>/images/<?php echo $post->status; ?>.png" width="25" height="25" /></td>
                    <td> 
<a href="<?php echo $url = admin_url(); ?>admin.php?page=mt-top-level-handle-<?php echo $page_url; ?>&action=edit&id=<?php echo $post->id; ?>">
...
<a style="cursor:pointer" onClick="del('<?php echo $url = admin_url(); ?>admin.php?page=mt-top-level-handle-<?php echo $page_url; ?>&action=delete&id=<?php echo $post->id; ?>')"  >
